...
function get_pilot_info($link, $pilPk)
{
    ...
    $result = mysql_query($sql,$link) or die('get_pilot_info failed: ' . mysql_error());
    ...
    $result = mysql_query($sql,$link) or die('get_pilot_info (2) failed: ' . mysql_error());
...
function get_pilot_tracks($link, $pilPk)
{
    ...
    $result = mysql_query($sql,$link) or die('get_pilot_tracks failed: ' . mysql_error());
...
$tracks = get_pilot_tracks($link, $pilPk);
