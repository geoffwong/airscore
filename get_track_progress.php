...
function track_progress($tasPk, $trackid)
{
    ...
    if ($trackid > 0)
    {
        ...
        $result = mysql_query($sql,$link) or json_die('Task turnpoints failed: ' . mysql_error());
        ...
        $result = mysql_query($sql,$link) or json_die('Duplicate track select failed: ' . mysql_error());
