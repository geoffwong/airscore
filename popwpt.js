function set_altitude(result) 
{
    //console.log(data);
    //var result = JSON.parse(data);
    $('#alt').val(result.results[0].elevation);
}
function get_altitude(position)
{
    $.ajax({
        crossOrigin: true,
        url: "https://maps.googleapis.com/maps/api/elevation/json?locations=" + position.lat + "," + position.lng,
        type: "GET",
